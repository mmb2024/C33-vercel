...
const Banner = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<div class="hero svelte-1vsfmdv"><div class="container"><h2 class="svelte-1vsfmdv">Cumbaya, Quito - Ecuador</h2>
    <p class="svelte-1vsfmdv">En el mejor sector de Cumbaya.
    </p></div>
</div>`;
});
